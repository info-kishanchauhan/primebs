<?php
namespace Internalnotes\Controller;
...
class IndexController extends AbstractActionController
{
    ...
    public function getrecAction()
    {
        ...
        if ($request->isPost()) {
            ...
            $projectTable = new TableGateway('tbl_internal_notes', $adapter);
        ...
        if ($request->isPost()) {
            ...
            $projectTable = new TableGateway('tbl_internal_notes', $adapter);
				...
				if($request->getPost("pAction") == "ADD")
				{
					...
					//$customObj->createlog("module='Internalnotes',action='Internalnotes ".$aData['name']." Added',action_id='".$iMasterID."' ");
					$result['DBStatus'] = 'OK';
				}
				else  if($request->getPost("pAction") == "EDIT")
				{
					...
					//$customObj->createlog("module='Internalnotes',action='Internalnotes ".$aData['name']." Edited',action_id='".$iMasterID."' ");
					$result['DBStatus'] = 'OK';
				}
        }
        else
...
public function fnGrid()
{
     ...
     */
    $aColumns = array('id','notes','color_code');
    /* Indexed column (used for fast and accurate table cardinality) */
    $sIndexColumn = "id";
    /* DB table to use */
    $sTable = "tbl_internal_notes";
    $config = $this->getServiceLocator()->get('config');
    $arrDBInfo=$config['db'];
    /* Database connection information */
    $gaSql['internalnotes']       = $arrDBInfo['username'];
