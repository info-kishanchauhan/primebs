...
<col width="20%">
                ...
                <tr>
					...
					<th><i class="fa fa-fw text-muted hidden-md hidden-sm hidden-xs"></i>  <?php echo $this->translate('Internal Note'); ?></th>

					<th><i class="fa fa-fw text-muted hidden-md hidden-sm hidden-xs"></i>  <?php echo $this->translate('Color Code'); ?></th>
