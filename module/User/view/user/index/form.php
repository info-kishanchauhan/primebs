									...
									<div class="row">
										<div class="col-md-3">
											...
											<fieldset style="margin-top: 15px;">
												...
												<div class="row">
														<section class="form-group form-group-sm clearfix">
															<label class="col-md-12 control-label"><strong class="txt-color-blue"><?php echo $this->translate('Postal Address'); ?></strong></label>
															<label class="col-md-12"> 
...
<div style="background: #eef7ff; padding: 18px 22px; border-left: 5px solid #007bff; border-radius: 10px; font-size: 12px; color: #2c3e50; line-height: 1.6; margin-bottom: 25px;">
  ...
  <?php echo $this->translate('Account Type'); ?>
  <span data-toggle="tooltip" title="Set the user's access level (Limited, Standard)" class="tooltip-icon">
    ...
    <div class="col-md-12">
        <label class="col-md-12"> 
            <select name="user_type" id="user_type1" class="select2" tabindex="4" style="width: 100%;">
                <option value="0">Select Account Type</option>
                <option value="Limited Access">Limited Access</option>
                <option value="Standard" <?php echo ($this->user_type == 'Standard') ? 'selected' : ''; ?>>Standard</option>
                <?php if ($_SESSION["user_id"] == '0' || $_SESSION['STAFFUSER'] == '1') { ?>
                    <option value="Enterprise" <?php echo ($this->user_type == 'Enterprise') ? 'selected' : ''; ?>>Enterprise</option>
                <?php } ?>
            </select>
        </label>
    </div>
...
<?php if ($_SESSION["user_id"] == '0' || $_SESSION['STAFFUSER'] == '1') { ?>
<!-- Date Section: Only visible if 'Limited Access' -->
<div class="row normal_user_dates hide">
    <div class="col-md-6 main_user_div">
        <div class="row">
            <section class="form-group-sm clearfix">
                <label class="col-md-12 control-label"><strong class="txt-color-blue"><?php echo $this->translate('Start Date'); ?></strong></label>
                <label class="col-md-12"> 
    ...
    <div class="col-md-6 main_user_div">
        <div class="row">
            <section class="form-group-sm clearfix">
                <label class="col-md-12 control-label"><strong class="txt-color-blue"><?php echo $this->translate('End Date'); ?></strong></label>
                <label class="col-md-12"> 
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#007bff" viewBox="0 0 24 24">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 
        10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/>
												...
												<h3 class="section-title-with-tooltip">
  Services
  <span data-toggle="tooltip" title="Enable YouTube-related promotion and monetization" class="tooltip-icon">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#007bff" viewBox="0 0 24 24">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 
        10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/>
    </svg>
												...
												<div class="col-md-12">
														<div class="checkbox">
															<label for="easyEntryEditForm-isCompil-0">
																	<input type="checkbox" class="" name="user_access[]" id="promotion" value="Promotion" > Youtube Services
															</label>
														</div>
												</div><br>
												<h3 class="section-title-with-tooltip">
...
<div class="col-md-12">
    <div class="checkbox">
        <label>
            <input type="checkbox" name="user_access[]" id="tickets" value="Tickets & History"> Tickets & History
        </label>
    </div>
</div>
...
<div class="col-md-12">
    <div class="checkbox">
        <label>
            <input type="checkbox" name="user_access[]" id="support" value="Rights Manager"> Rights Manager
        </label>
    </div>
</div>
...
<div class="col-md-12">
    <div class="checkbox">
        <label>
            <input type="checkbox" name="user_access[]" id="faq" value="FAQ"> FAQ
        </label>
    </div>
												...
												<h3 class="section-title-with-tooltip">
  Accounting
  <span data-toggle="tooltip" title="View royalty statements and track payment records" class="tooltip-icon">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#007bff" viewBox="0 0 24 24">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 
        10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/>
    </svg>
												...
												<div class="col-md-12">
														<div class="checkbox">
															<label for="easyEntryEditForm-isCompil-0">
																	<input type="checkbox" class="" name="user_access[]" id="payment" value="Payment" > Payment
															</label>
														</div>
												</div></div>
												<?php } ?>
														<div class="col-md-12">
																<div class="checkbox">
																	<label for="easyEntryEditForm-isCompil-0">
																			<input type="checkbox" class="" name="user_access[]" id="statements" value="Statements" > Statements
																	</label>
																</div>
														</div>
												<br>
												...
												<div class="col-md-12">
														<label class="col-md-12"> 
																...
																<input type="radio" class="" name="payment_system" id="payment_system1" value="Monthly" tabindex="4" > Monthly</label>
																<label class="radio-inline">
																<input type="radio" class="" name="payment_system" id="payment_system2" value="Quarterly" tabindex="4" checked> Quarterly</label>
																<small></small>
														</label>
												</div><br>
												...
												<div class="col-md-12">
														<label class="col-md-12"> 
																<select type="select" id="payment_method" name="payment_method" class="select2" >
												...
												<h3 class="section-title-with-tooltip">
  Royalty Share
  <span data-toggle="tooltip" title="Set the user's percentage share of royalties" class="tooltip-icon">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#007bff" viewBox="0 0 24 24">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 
        10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/>
    </svg>
												...
												<div class="col-md-12">
														<div class="checkbox">
															<label for="easyEntryEditForm-isCompil-0">
																	<input type="checkbox" class="" name="user_access[]" id="royalty_rate" value="Royalty Rate" > Add the royalty rate between the user and you
															</label>
														</div>
														<label>User's Share</label>
														<input type="number"  class="form-control" name="royalty_rate_per" id="royalty_rate_per" style="width:120px;">
												</div>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#007bff" viewBox="0 0 24 24">
        ...
        10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/>
												...
												<?php
													...
													{
												?>
												<div class="row releasing_network ">
													<section class="form-group form-group-sm clearfix">
														<label class="col-md-12 control-label"><strong class="txt-color-blue"><?php echo $this->translate('Release Management System'); ?></strong>
														<a class="left btn btn-success btn-icon-inline btn-sm mb15 addEventBtn" id="net_select_all"><i class="ion ion-plus"></i> Select All</a>
														<a class="left btn btn-success btn-icon-inline btn-sm mb15 addEventBtn" id="net_remove_all"><i class="ion ion-minus"></i> Remove All</a>
														</label>
														<label class="col-md-12"> 
															<select type="multiselect" id="releasing_network" name="releasing_network" class="select2" multiple>
									...
									<?php if ($_SESSION["user_id"] == '0' || $_SESSION['STAFFUSER'] == '1' ) { ?>		
												<div class="row main_user_div">
													
														<section class="form-group form-group-sm clearfix">
															<label class="col-md-12 control-label"><strong class="txt-color-blue"><?php echo $this->translate('Assign Label Manager Email'); ?></strong></label>
															<label class="col-md-12"> 
																<input type="text" id="label_manager_email" name="label_manager_email" class="form-control " >
																<small></small>
															</label>
														</section>
												</div>
												<div class="row">
														<section class="form-group form-group-sm clearfix">
															<label class="col-md-12" style="margin-top:10px;"> 
																<button id="viewSubuser" class="btn-primary" form="attributeVerification" aria-label="Continue"   style="">View Subuser<span id="subusercnt"></span></button>
															</label>
														</section>
												</div>
												<?php } ?>
