...
class IndexController extends AbstractActionController
{
    ...
    public function  deleteAction()
    {
        ...
        if ($request->isPost()) {
            ...
            if ($request->getPost("pAction") == "DELETE") {
				...
				$rowset = $rowset->toArray();
				$info= $rowset[0]['name'];
				$customObj->createlog("module='Department',action='Department ".$info." Deleted',action_id='".$iMasterID."' ");
    ...
    if($request->getPost("pAction") == "ADD")
    {
		...
		//$customObj->createlog("module='Department',action='Department ".$aData['name']." Added',action_id='".$iMasterID."' ");
        $result['DBStatus'] = 'OK';
    }
    else  if($request->getPost("pAction") == "EDIT")
    {
		...
		//$customObj->createlog("module='Department',action='Department ".$aData['name']." Edited',action_id='".$iMasterID."' ");
        $result['DBStatus'] = 'OK';
    }
        }
        else
