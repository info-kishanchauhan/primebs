...
<col width="20%">
                ...
                <tr>
					...
					<th><i class="fa fa-fw text-muted hidden-md hidden-sm hidden-xs"></i>  <?php echo $this->translate('Label'); ?></th>
					 <th><i class="fa fa-fw text-muted hidden-md hidden-sm hidden-xs"></i> <?php echo $this->translate('Assigned User'); ?> </th>
