...
">
  <img src="<?= $flagUrlPk ?>" alt="Pakistan" style="width: 20px; height: 14px; border-radius: 2px; box-shadow: 0 0 2px rgba(0,0,0,0.2);">
  <div style="font-size: 14px; color: #7f1d1d;">
    ⚠️ Currently, we <strong>do not support payouts</strong> for <strong>Pakistan</strong>. 
    Please <a href="https://www.primebackstage.in/tickets" target="_blank" style="color: #b91c1c; text-decoration: underline;">contact support</a> for assistance.
  </div>
</div>
